...
import { C as Slot$1, E as useComposedRefs, S as cva, T as composeRefs, _ as DismissableLayer, c as Portal, d as Content, f as Root2$1, h as useId$1, l as Anchor, o as useControllableState, p as createPopperScope, s as Presence, u as Arrow, v as useCallbackRef$1, w as createSlot$2, x as cn, y as composeEventHandlers } from "./tooltip-CwlCdP1-.js";
...
var ChevronRight = createLucideIcon("chevron-right", [["path", {
	...
	let M = createSlot$2(`Primitive.${j}`), N = React$1.forwardRef((n, N) => {
		let { asChild: P, ...F } = n, I = P ? M : j;
		return typeof window < "u" && (window[Symbol.for("radix-ui")] = !0), /* @__PURE__ */ jsx(I, {
			...F,
			ref: N
		});
	});
	return N.displayName = `Primitive.${j}`, {
		...n,
		[j]: N
	};
...
}), Badge = React$1.forwardRef(({ className: n, variant: M, asChild: N = !1, ...P }, F) => /* @__PURE__ */ jsx(N ? Slot$1 : "span", {
	ref: F,
	"data-slot": "badge",
	className: cn(badgeVariants({ variant: M }), n),
	...P
}));
Badge.displayName = "Badge";
function createContextScope(n, j = []) {
	let M = [];
	function N(j, N) {
		let P = React$1.createContext(N), F = M.length;
		M = [...M, N];
		let I = (j) => {
			let { scope: M, children: N, ...I } = j, L = M?.[n]?.[F] || P, R = React$1.useMemo(() => I, Object.values(I));
			return /* @__PURE__ */ jsx(L.Provider, {
				value: R,
				children: N
			});
		};
		I.displayName = j + "Provider";
		function L(M, I) {
			let L = I?.[n]?.[F] || P, R = React$1.useContext(L);
			if (R) return R;
			if (N !== void 0) return N;
			throw Error(`\`${M}\` must be used within \`${j}\``);
		}
		return [I, L];
	}
	let P = () => {
		let j = M.map((n) => React$1.createContext(n));
		return function(M) {
			let N = M?.[n] || j;
	...
	return P.scopeName = n, [N, composeContextScopes(P, ...j)];
}
function composeContextScopes(...n) {
	let j = n[0];
	if (n.length === 1) return j;
	let M = () => {
		let M = n.map((n) => ({
			useScope: n(),
		...
		return function(n) {
			let N = M.reduce((j, { useScope: M, scopeName: N }) => {
				let P = M(n)[`__scope${N}`];
				return {
					...j,
					...P
			...
			return React$1.useMemo(() => ({ [`__scope${j.scopeName}`]: N }), [N]);
		};
	};
	return M.scopeName = j.scopeName, M;
}
var count = 0;
...
function createSlot$1(n) {
	let j = /* @__PURE__ */ createSlotClone$1(n), M = React$1.forwardRef((n, M) => {
		let { children: N, ...P } = n, F = React$1.Children.toArray(N), I = F.find(isSlottable$1);
		if (I) {
...
function createSlotClone$1(n) {
	let j = React$1.forwardRef((n, j) => {
		...
		if (React$1.isValidElement(M)) {
			let n = getElementRef$1(M), F = mergeProps$1(N, M.props);
			return M.type !== React$1.Fragment && (F.ref = j ? composeRefs(j, n) : n), React$1.cloneElement(M, F);
		}
...
var Primitive$1 = [
	...
	let M = /* @__PURE__ */ createSlot$1(`Primitive.${j}`), N = React$1.forwardRef((n, N) => {
		let { asChild: P, ...F } = n, I = P ? M : j;
		return typeof window < "u" && (window[Symbol.for("radix-ui")] = !0), /* @__PURE__ */ jsx(I, {
			...F,
			ref: N
	...
	bubbles: !1,
	cancelable: !0
}, FOCUS_SCOPE_NAME = "FocusScope", FocusScope = React$1.forwardRef((n, j) => {
	let { loop: N = !1, trapped: P = !1, onMountAutoFocus: F, onUnmountAutoFocus: I, ...L } = n, [R, z] = React$1.useState(null), B = useCallbackRef$1(F), V = useCallbackRef$1(I), H = React$1.useRef(null), U = useComposedRefs(j, (n) => z(n)), W = React$1.useRef({
		paused: !1,
		pause() {
			this.paused = !0;
		},
...
function createSlotClone(n) {
	let j = React$1.forwardRef((n, j) => {
		let { children: M, ...N } = n;
		if (React$1.isValidElement(M)) {
			let n = getElementRef(M), F = mergeProps(N, M.props);
			return M.type !== React$1.Fragment && (F.ref = j ? composeRefs(j, n) : n), React$1.cloneElement(M, F);
		}
		return React$1.Children.count(M) > 1 ? React$1.Children.only(null) : null;
	});
...
var Primitive = [
	...
	let M = /* @__PURE__ */ createSlot(`Primitive.${j}`), N = React$1.forwardRef((n, N) => {
		let { asChild: P, ...F } = n, I = P ? M : j;
		return typeof window < "u" && (window[Symbol.for("radix-ui")] = !0), /* @__PURE__ */ jsx(I, {
			...F,
			ref: N
...
var Combination_default = ReactRemoveScroll, POPOVER_NAME = "Popover", [createPopoverContext, createPopoverScope] = createContextScope(POPOVER_NAME, [createPopperScope]), usePopperScope = createPopperScope(), [PopoverProvider, usePopoverContext] = createPopoverContext(POPOVER_NAME), Popover$1 = (n) => {
	let { __scopePopover: j, children: M, open: N, defaultOpen: P, onOpenChange: F, modal: I = !1 } = n, L = usePopperScope(j), B = React$1.useRef(null), [H, U] = React$1.useState(!1), [W, G] = useControllableState({
		prop: N,
		defaultProp: P ?? !1,
		onChange: F,
		caller: POPOVER_NAME
	...
	return /* @__PURE__ */ jsx(Root2$1, {
		...
		children: /* @__PURE__ */ jsx(PopoverProvider, {
			...
			hasCustomAnchor: H,
			onCustomAnchorAdd: React$1.useCallback(() => U(!0), []),
			onCustomAnchorRemove: React$1.useCallback(() => U(!1), []),
			modal: I,
			children: M
		})
	});
...
var TRIGGER_NAME = "PopoverTrigger", PopoverTrigger$1 = React$1.forwardRef((n, j) => {
	let { __scopePopover: N, ...P } = n, F = usePopoverContext(TRIGGER_NAME, N), I = usePopperScope(N), L = useComposedRefs(j, F.triggerRef), R = /* @__PURE__ */ jsx(Primitive.button, {
		type: "button",
		...
		...P,
		ref: L,
		onClick: composeEventHandlers(n.onClick, F.onOpenToggle)
	});
	return F.hasCustomAnchor ? R : /* @__PURE__ */ jsx(Anchor, {
		asChild: !0,
		...I,
		children: R
	});
...
var Slot = /* @__PURE__ */ createSlot("PopoverContent.RemoveScroll"), PopoverContentModal = React$1.forwardRef((n, j) => {
	let N = usePopoverContext(CONTENT_NAME, n.__scopePopover), P = React$1.useRef(null), F = useComposedRefs(j, P), I = React$1.useRef(!1);
	...
	let { __scopePopover: M, trapFocus: N, onOpenAutoFocus: P, onCloseAutoFocus: I, disableOutsidePointerEvents: R, onEscapeKeyDown: z, onPointerDownOutside: B, onFocusOutside: V, onInteractOutside: H, ...U } = n, W = usePopoverContext(CONTENT_NAME, M), G = usePopperScope(M);
	...
	let { __scopePopover: M, ...N } = n, P = usePopoverContext(CLOSE_NAME, M);
	return /* @__PURE__ */ jsx(Primitive.button, {
		type: "button",
		...N,
		ref: j,
		onClick: composeEventHandlers(n.onClick, () => P.onOpenChange(!1))
	});
});
...
export { Sparkles as _, stripMarkdownForSpeech as a, PopoverTrigger as c, FocusScope as d, useFocusGuards as f, Volume2 as g, Zap as h, getVoiceSupport as i, Combination_default as l, Primitive$2 as m, SpeechSynthesisManager as n, Popover as o, Badge as p, defaultVoiceConfig as r, PopoverContent as s, SpeechRecognitionManager as t, hideOthers as u, ChevronRight as v };
