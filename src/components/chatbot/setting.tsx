              ...
              <div className="space-y-1.5">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <span className="truncate text-xs">{currentAgent?.key || selectedAgent}</span>
                    ...
                    {metadata?.agents.map((agent) => (
                      <DropdownMenuItem
                        ...
                        className={cn(
                          ...
                          selectedAgent === agent.key && "bg-primary/10 text-primary focus:bg-primary/15 focus:text-primary"
                        )}
                      >
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      ...
                      className="w-full justify-between px-3 font-normal h-9 bg-background hover:bg-muted/50 border-input/60"
                    >
                      <span className="truncate text-xs">{currentModel}</span>
                      <ChevronDown className="h-3 w-3 opacity-50 shrink-0" />
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent align="end" className="w-[180px]">
                    ...
                    {metadata?.models.map((model) => (
                      <DropdownMenuItem
                        ...
                        className={cn(
                          "cursor-pointer text-xs",
                          selectedModel === model && "bg-primary/10 text-primary focus:bg-primary/15 focus:text-primary"
                        )}
                      >
                        {model}
                      </DropdownMenuItem>
                            ...
                            {voices.map((voice) => (
                              ...
                              >
                                <div className="flex items-center gap-2">
                                  ...
                                  {voice.localService && (
                                    <Badge variant="secondary" className="text-[9px] px-1 h-4 rounded-sm">Local</Badge>
                                  )}
                                </div>
                              </SelectItem>
                            ))}
