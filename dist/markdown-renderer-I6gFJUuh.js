...
function compress(e, t, n) {
	return (r) => r < e ? 0 : r > t ? 1 : n(progress(e, t, r));
}
function animateSingleValue(t, n, r) {
	let i = isMotionValue(t) ? t : motionValue(t);
	return i.start(animateMotionValue("", i, n, r)), i.animation;
}
...
function createProjectionNode({ attachResizeListener: t, defaultParent: n, measureScroll: r, checkIsScrollRoot: i, resetTransform: a }) {
	return class {
		...
		mount(e) {
			...
			this.isSVG = isSVGElement(e) && !isSVGSVGElement(e), this.instance = e;
...
function getVelocity(e, t) {
	...
	for (; n >= 0 && (r = e[n], !(i.timestamp - r.timestamp > secondsToMilliseconds(t)));) n--;
	if (!r) return {
		x: 0,
		y: 0
	};
	r === e[0] && e.length > 2 && i.timestamp - r.timestamp > secondsToMilliseconds(t) * 2 && (r = e[1]);
	let a = millisecondsToSeconds(i.timestamp - r.timestamp);
	if (a === 0) return {
		x: 0,
		y: 0
	};
...
function fromMarkdown(e, t, n) {
	return t && typeof t == "object" && (n = t, t = void 0), compiler(n)(postprocess(parse$2(n).document().write(preprocess()(e, t, !0))));
}
function compiler(e) {
	let t = {
		transforms: [],
...
function visitParents(e, t, n, r) {
	...
	function c(e, i, l) {
		...
		if (typeof u.type == "string") {
			...
			Object.defineProperty(d, "name", { value: "node (" + color(e.type + (t ? "<" + t + ">" : "")) + ")" });
		}
		return d;
		function d() {
			let u = empty, d, f, p;
...
function toHast(e, t) {
	let n = createState(e, t), r = n.one(e, void 0), i = footer(n), a = Array.isArray(r) ? {
		type: "root",
		children: r
	} : r || {
		type: "root",
...
function createContextScope(e, t = []) {
	...
	function r(t, r) {
		...
		n = [...n, r];
		let o = (t) => {
			let { scope: n, children: r, ...o } = t, c = n?.[e]?.[a] || i, l = React$1.useMemo(() => o, Object.values(o));
		...
		function c(n, o) {
			let c = o?.[e]?.[a] || i, l = React$1.useContext(c);
			if (l) return l;
...
}, {}), originalBodyUserSelect, HOVERCARD_NAME = "HoverCard", [createHoverCardContext, createHoverCardScope] = createContextScope(HOVERCARD_NAME, [createPopperScope]), usePopperScope = createPopperScope(), [HoverCardProvider, useHoverCardContext] = createHoverCardContext(HOVERCARD_NAME), HoverCard = (e) => {
	let { __scopeHoverCard: t, children: n, open: r, defaultOpen: i, onOpenChange: a, openDelay: o = 700, closeDelay: c = 300 } = e, l = usePopperScope(t), u = React$1.useRef(0), d = React$1.useRef(0), f = React$1.useRef(!1), p = React$1.useRef(!1), [m, g] = useControllableState({
		prop: r,
		defaultProp: i ?? !1,
		onChange: a,
		caller: HOVERCARD_NAME
	}), _ = React$1.useCallback(() => {
		clearTimeout(d.current), u.current = window.setTimeout(() => g(!0), o);
	}, [o, g]), v = React$1.useCallback(() => {
		clearTimeout(u.current), !f.current && !p.current && (d.current = window.setTimeout(() => g(!1), c));
	}, [c, g]), y = React$1.useCallback(() => g(!1), [g]);
...
var HoverCardContentImpl = React$1.forwardRef((e, t) => {
	let { __scopeHoverCard: n, onEscapeKeyDown: r, onPointerDownOutside: i, onFocusOutside: a, onInteractOutside: o, ...c } = e, l = useHoverCardContext(CONTENT_NAME, n), u = usePopperScope(n), d = React$1.useRef(null), f = useComposedRefs(t, d), [p, m] = React$1.useState(!1);
	return React$1.useEffect(() => {
		if (p) {
			let e = document.body;
	...
	}, [l.isPointerDownOnContentRef, l.hasSelectionRef]), React$1.useEffect(() => {
		d.current && getTabbableNodes(d.current).forEach((e) => e.setAttribute("tabindex", "-1"));
		...
		children: /* @__PURE__ */ jsx(Content, {
			...u,
			...c,
			onPointerDown: composeEventHandlers(c.onPointerDown, (e) => {
...
const LinkPreview = ({ children: e, url: t, className: n, width: r = 200, height: i = 125, isStatic: a = !1, imageSrc: o = "" }) => {
	let c;
	c = a ? o : `https://api.microlink.io/?${new URLSearchParams({
		url: t,
		screenshot: "true",
		meta: "false",
		...
		"viewport.width": String(r * 3),
		"viewport.height": String(i * 3)
	}).toString()}`;
	...
	let p = {
		stiffness: 100,
		damping: 15
	}, m = useMotionValue(0), g = useSpring(m, p);
...
function withClass(e, t) {
	let n = ({ className: n, ...r }) => React.createElement(e, {
		...r,
		className: cn(t, n)
	});
...
var components = {
	...
	a({ className: e, children: t, href: n, ...r }) {
		return n ? /* @__PURE__ */ jsx(LinkPreview, {
			url: n,
			className: cn("text-primary underline underline-offset-2 hover:opacity-80 transition-opacity", e),
			children: t
		}) : /* @__PURE__ */ jsx("a", {
			className: cn("text-primary underline underline-offset-2 hover:opacity-80 transition-opacity", e),
			...r,
	...
	code({ className: e, children: t, ...n }) {
		return /* @__PURE__ */ jsx("code", {
			className: cn("rounded bg-muted px-1 py-0.5 font-mono text-sm", e),
			...n,
			children: t
		});
	},
